           ...
           <div class="col-sm-12 col-md-6 col-lg-6 mx-auto">
             ...
             ?>
              <div class="border border-dark border-4 my-5 px-4">
                 ...
                 <div class="form-floating my-3">
                   <input type="text" class="form-control" id="Phone_no" name="phone_no" value="<?php echo $old['phone_no']??$_SESSION['authenticate']['phone_no']?? ''; ?>">
                   <label for="Phone_no">Phone No.</label>
                  </div>
                   
                 <div class="form-floating my-3">
                   <input type="text" class="form-control" id="Address" name="address" value="<?php echo $old['address']??$_SESSION['authenticate']['address']?? ''; ?>">
             ...
             ?> 
             <div class="border border-dark border-4 my-5 px-4">
                  <h3 class="text-center text-black my-2 fw-bold">Payment Information<span class="text-body"> +8801776487402</span></h3>
                  <div class="my-3 ms-0">
                  <div>
                    <input type="radio" class="btn-check" name="payment_policy" id="cod" autocomplete="off" value="cod" <?php echo isset($old['payment_policy']) && $old['payment_policy'] == 'cod'? 'checked' : ''; ?>>
                    <label class="btn btn-outline-danger" for="cod">Cash on delivery</label> 
                  </div>
                ...
                <div class="collapse" id="collapseExample">
                  <div class="">
                    <div class="form-floating my-3">
                       <input type="text" class="form-control" id="Sender_number" name="sender_number" value="<?php echo $old['sender_number']??$_SESSION['authenticate']['phone_no']?? ''; ?>">
