    ...
    <?php
       ...
       $brands_index = $brand->sub_categories_index();

       

     
      if(isset($_POST['add_brands'])){
          $brand_add = $brand->Brands_add();
          
           if($brand_add['status'] == 'error'){
             $errors = $brand_add['message'];
         }
          if($brand_add['status'] == 'success'){
             $success = $brand_add['message'];
         }  
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
          <h5 class="text-white fw-bold fs-1">Create Brand</h5>
             ...
             <form method="post" enctype="multipart/form-data">
                ...
                <div class="form-floating my-3">
                 ...
                 <div class="d-flex justify-content-center">
                     <button type="submit" class="btn btn-dark me-2" style="padding:10px 30px;" name="add_brands">Submit</button> 
