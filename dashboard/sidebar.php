...
<div class="container-fluid">
  <div class="row">
    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block sidebar collapse" style="background-color:#fe0404c4;">
      ...
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link <?php echo (str_contains($_SERVER['PHP_SELF'], 'dashboard/categories')) ? 'active': ''; ?> fw-bold" href="categories.php" style="font-size:20px;">
          ...
          <li class="nav-item">
            <a class="nav-link <?php echo (str_contains($_SERVER['PHP_SELF'], 'dashboard/products')) ? 'active': ''; ?> fw-bold" href="products.php" style="font-size:20px;">
          ...
          <li class="nav-item">
            <a class="nav-link <?php echo (str_contains($_SERVER['PHP_SELF'], 'dashboard/orders')) || (str_contains($_SERVER['PHP_SELF'], 'dashboard/order_lists')) ? 'active': ''; ?> fw-bold" href="orders.php" style="font-size:20px;">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file"><path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path><polyline points="13 2 13 9 20 9"></polyline></svg>
              Orders
            </a>
          </li>
