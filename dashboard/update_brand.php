    ...
    <?php
      ...
      $targetdata = $brand->targetBrandData($_GET['id']);
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h5 class="text-white fw-bold fs-1">Update <span class="text-black"><?php echo $targetdata['name']; ?></span> Brand</h5>
           <!-- Button trigger modal -->
           <div class="d-flex justify-content-end my-3">
                <!-- Button trigger modal -->
                 <a href="brand.php" class="btn btn-dark">
           ...
           <div class="col-9 mx-auto">   
             <form method="post" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-center">
                   <img src="../images/brands_img/<?php echo $targetdata['image']??''; ?>" style="width:200px;"> 
                </div>
                ...
                <div class="form-floating my-3">
                 ...
                 <div class="d-flex justify-content-center">
                     <button type="submit" class="btn btn-light me-2" style="padding:10px 30px;" name="edit_brand">Update</button> 
                 </div>  
             </form>   
           </div>
        </div>  
