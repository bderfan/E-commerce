    ...
    <?php
      ...
      $targetdata = $add_product->targetData($_GET['sku']);
           ...
           <div class="col-9 mx-auto">   
             <form method="post" enctype="multipart/form-data">
               ...
               <div class="form-floating my-3">
                ...
                <div class="form-floating my-3">
                      <textarea type="text" class="form-control" style="height:100px;" id="details" name="details"><?php echo $old['details']??$targetdata['details']??''; ?></textarea>
