...
<!============================= Registration part ==================================>
  <section id="registration" style="background-color: #030021;">
    <div class="container">
      ...
      <form class="row" method="post">
        <div class="col-6 mx-auto">
          ...
          <p class="text-danger" style="font-size:15px;"> <?php echo $errors['name']??'' ?></p>
          ...
          <p class="text-danger" style="font-size:15px;"> <?php echo $errors['age']??'' ?></p>
          ...
          <p class="text-danger" style="font-size:15px;"> <?php echo $errors['phone_no']??'' ?></p>
          ...
          <p class="text-danger" style="font-size:15px;"> <?php echo $errors['email']??'' ?></p>
          ...
          <p class="text-danger" style="font-size:15px;"> <?php echo $errors['password']??'' ?></p>
          ...
          <p class="text-danger" style="font-size:15px;"> <?php echo $errors['confirm_password']??'' ?></p>
            
           <div class="form-floating my-3">
            <input type="text" class="form-control" id="Address" name="address" value="">
            <label for="Address">Address</label>
          </div>
          <p class="text-danger" style="font-size:15px;"> <?php echo $errors['address']??'' ?></p>
            
            
          <div class="d-flex justify-content-center">
            <button type="submit" class="btn btn-danger" style="padding:10px 30px;" name="Registered">Registration</button>
          </div>
            
           <h5 class="text-center mt-5"><a href="login.php" class="text-warning">Old user? Please log in...</a></h5>
        </div>
      </form>
    </div>  
  </section>
